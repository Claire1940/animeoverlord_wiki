...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Anime Overlord Wiki",
    description: "Read the Terms of Service for Anime Overlord Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Overlord anime resource platform.",
    keywords: [
      'terms of service',
      "Anime Overlord Wiki terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - Anime Overlord Wiki",
      description: "Terms and conditions for using Anime Overlord Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Anime Overlord Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Anime Overlord Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Anime Overlord Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Anime Overlord Wiki is an unofficial, community-driven fan website that provides information, guides,
              and resources related to the Overlord anime series. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Watch order guides and episode summaries</li>
              <li>Character profiles and lore guides</li>
              <li>Season and movie information</li>
              <li>World-building and Nazarick lore</li>
              <li>Light novel adaptation guides</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Anime Overlord Wiki is NOT affiliated with, endorsed by, or associated with
              Kadokawa Corporation or the official creators of Overlord. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Anime Overlord Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Kadokawa Corporation and/or the creators of Overlord. We use such
            ...
            <ul>
              ...
              <li><strong>Streaming Availability:</strong> Anime streaming availability on Crunchyroll or other platforms may change without notice. We are not responsible for streaming access changes.</li>
            </ul>
            <p>
            ...
            <p>
              The Website may contain links to third-party websites, including Crunchyroll, Discord, social media platforms,
            ...
            <p>
              ...
              you and Anime Overlord Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@animeoverlord.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@animeoverlord.wiki</a>
            </p>
            <p>
