...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Anime Overlord Wiki',
    description: 'Anime Overlord Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Overlord anime resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Anime Overlord Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Anime Overlord Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Crunchyroll, Discord, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Anime Overlord Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Kadokawa Corporation, Kugane Maruyama, or any official Overlord rights holders. All anime content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@animeoverlord.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@animeoverlord.wiki</a>
            </p>
            <p>
