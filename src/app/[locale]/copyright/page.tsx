...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Anime Overlord Wiki',
    description: 'Copyright and intellectual property information for Anime Overlord Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Anime Overlord Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Anime Overlord Wiki',
      description: 'Copyright and intellectual property information for Anime Overlord Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Anime Overlord Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Anime Overlord Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Anime Overlord Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Kadokawa Corporation</strong> - Publisher of Overlord anime</li>
              <li><strong>Kugane Maruyama</strong> - Author of the Overlord light novels</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>OVERLORD</strong> - Trademark of Kadokawa Corporation and Kugane Maruyama</li>
              <li><strong>Anime Overlord Wiki</strong> - Our own branding (not affiliated with the anime creators)</li>
            </ul>
            <p>
              ...
              affiliation with Anime Overlord Wiki.
            </p>
            ...
            <p>
              ...
              Anime Overlord Wiki<br />
              Email: <a href="mailto:dmca@animeoverlord.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animeoverlord.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Anime Overlord Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Anime Overlord Wiki (animeoverlord.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@animeoverlord.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@animeoverlord.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@animeoverlord.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@animeoverlord.wiki</a>
            </p>
            <p>
